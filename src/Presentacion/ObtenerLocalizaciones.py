...
<html lang="es">
    ...
    <body>
        <header class="barraNav">
            ...
            <nav class="barraNav">
                <ul class="barraNav">
                    <li><a href="index.html"><img src="https://cdn-icons-png.flaticon.com/512/1779/1779957.png" wight="25px" height="25px" alt="Atrás"></a></li>
                    <li><a href="formulario-registro.html">Regístrate <img src="https://cdn-icons-png.flaticon.com/512/6861/6861326.png" wight="25px" height="25px"alt="Registrate"></a></li>
                    <li><a href="Carrito-vacio.htm">Carrito <img src="https://cdn-icons-png.flaticon.com/512/5087/5087847.png" wight="25px" height="25px" alt="Carrito"></a></li>
                    <li><a href="https://www.correos.es/es/es/herramientas/localizador/envios">Envío a Domicilio <img src="https://cdn-icons-png.flaticon.com/512/1727/1727708.png" wight="25px" height="25px" alt="Envio a Domicilio"></a></li>
                    <li><a href="localizaciones-palma.html">Recogida en Tienda <img src="https://cdn-icons-png.flaticon.com/512/1727/1727781.png" wight="25px" height="25px" alt="Recogida en Tienda"></a></li>
                    <li><a href="https://www.palma.cat/portal/BICIPALMA/RecursosWeb/DOCUMENTOS/9/12_47262_2.pdf">Términos y Condiciones <img src="https://cdn-icons-png.flaticon.com/512/1727/1727801.png" wight="25px" height="25px" alt="Términos y Condiciones"></a></li>
                </ul>
            </nav>
        </header>
        <div class="maps">
