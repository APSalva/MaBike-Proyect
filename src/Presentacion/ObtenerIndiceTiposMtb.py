...
def ObtenerIndiceTiposMtb():
    indextiposmtb = f"""
<!DOCTYPE html>
<html lang="es">
    <head>
        <title>MaBike-Bicicletas de MTB</title>
        <meta charset="UTF-8">
    ...
    for value in Diccionario_JSON():
        if value["tipo"] == "Mtb" or value["tipo"] == "Mtb e-bike":
            img_bici = value["img"]
    ...
    crear_archivo = open("docs/index-MTB.html","w", encoding="UTF-8")
    crear_archivo.write(indextiposmtb)
